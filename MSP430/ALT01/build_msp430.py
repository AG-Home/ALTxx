...
retVal = subprocess.check_call("msp430-gcc-4.6.3 -mmcu=msp430g2553 build/Gpio_User.o build/Gpio_Service.o build/Agh_Driver.o build/Clock_User.o build/Interrupt_User.o build/main.o -o build/APPL.out", shell = True)
if(retVal == 0):
    print('APPL.out')
