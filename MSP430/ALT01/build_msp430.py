...
retVal = subprocess.check_call("msp430-gcc-4.6.3 -c -Iinclude/ -mmcu=msp430g2553 src/Mcu_Service.c -o build/Mcu_Service.o", shell = True)
if(retVal == 0):
    print('Mcu_Service.o')
